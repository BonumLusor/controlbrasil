...
export const appRouter = router({
  ...
  employees: router({
    list: protectedProcedure.query(async () => {
      return await employeesDb.getAllEmployees();
    }),
    listActive: protectedProcedure.query(async () => {
      return await employeesDb.getActiveEmployees();
    }),
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
        return await employeesDb.getEmployeeById(input.id);
      }),
    create: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await employeesDb.createEmployee(input);
      }),
  ...
  components: router({
    list: protectedProcedure.query(async () => {
      return await componentsDb.getAllComponents();
    }),
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
        return await componentsDb.getComponentById(input.id);
      }),
    getByType: protectedProcedure
      .input(z.object({ type: z.string() }))
      .query(async ({ input }) => {
        return await componentsDb.getComponentsByType(input.type);
      }),
    getLowStock: protectedProcedure.query(async () => {
      return await componentsDb.getLowStockComponents();
    }),
    search: protectedProcedure
      .input(z.object({ query: z.string() }))
      .query(async ({ input }) => {
        return await componentsDb.searchComponents(input.query);
      }),
    create: protectedProcedure
      .input(
        z.object({
      ...
      .mutation(async ({ input }) => {
        return await componentsDb.createComponent(input);
      }),
    update: protectedProcedure
      .input(
        z.object({
    ...
    updateQuantity: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await componentsDb.updateComponentQuantity(input.id, input.quantityChange);
      }),
    delete: protectedProcedure
      .input(z.object({ id: z.number() }))
      .mutation(async ({ input }) => {
  ...
  purchaseOrders: router({
    list: protectedProcedure.query(async () => {
      return await purchaseOrdersDb.getAllPurchaseOrders();
    }),
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
        return await purchaseOrdersDb.getPurchaseOrderById(input.id);
      }),
    getItems: protectedProcedure
      .input(z.object({ purchaseOrderId: z.number() }))
      .query(async ({ input }) => {
        return await purchaseOrdersDb.getPurchaseOrderItems(input.purchaseOrderId);
      }),
    create: protectedProcedure
      .input(
        z.object({
    ...
    receive: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await purchaseOrdersDb.receivePurchaseOrder(
          input.id,
          input.receivedById,
          input.itemsReceived
        );
  ...
  customers: router({
    ...
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
        return await customersDb.getCustomerById(input.id);
      }),
    search: protectedProcedure
      .input(z.object({ query: z.string() }))
      .query(async ({ input }) => {
        return await customersDb.searchCustomers(input.query);
      }),
    create: protectedProcedure
      .input(
        z.object({
      ...
      .mutation(async ({ input }) => {
        return await customersDb.createCustomer(input);
      }),
    update: protectedProcedure
      .input(
        z.object({
  ...
  serviceOrders: router({
    list: protectedProcedure.query(async () => {
      return await serviceOrdersDb.getAllServiceOrders();
    }),
    getById: protectedProcedure
      .input(z.object({ id: z.number() }))
      .query(async ({ input }) => {
        return await serviceOrdersDb.getServiceOrderById(input.id);
      }),
    getByStatus: protectedProcedure
      .input(z.object({ status: z.string() }))
      .query(async ({ input }) => {
        return await serviceOrdersDb.getServiceOrdersByStatus(input.status);
      }),
    getByCustomer: protectedProcedure
      .input(z.object({ customerId: z.number() }))
      .query(async ({ input }) => {
        return await serviceOrdersDb.getServiceOrdersByCustomer(input.customerId);
      }),
    create: protectedProcedure
      .input(
        z.object({
      ...
      .mutation(async ({ input }) => {
        return await serviceOrdersDb.createServiceOrder(input);
      }),
    update: protectedProcedure
      .input(
        z.object({
  ...
  commissions: router({
    calculate: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await commissionsDb.calculateCommission(input.employeeId, input.serviceOrderId, input.amount);
      }),
    getByEmployee: protectedProcedure
      .input(z.object({ employeeId: z.number() }))
      .query(async ({ input }) => {
        return await commissionsDb.getCommissionsByEmployee(input.employeeId);
      }),
    getPending: protectedProcedure
      .input(z.object({ employeeId: z.number().optional() }))
      .query(async ({ input }) => {
        return await commissionsDb.getPendingCommissions(input.employeeId);
      }),
    pay: protectedProcedure
      .input(z.object({ id: z.number() }))
      .mutation(async ({ input }) => {
        return await commissionsDb.payCommission(input.id);
      }),
  }),
  ...
  reports: router({
    monthly: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await reportsDb.getMonthlyReport(input.year, input.month);
      }),
    yearly: protectedProcedure
      .input(z.object({ year: z.number() }))
      .query(async ({ input }) => {
        return await reportsDb.getYearlyReport(input.year);
      }),
  }),
});
